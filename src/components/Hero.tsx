...
//   whileTap={{ scale: 0.95 }} className="mb-6 flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-4 py-1.5 text-xs">
//         <Briefcase size={14} className="text-orange-400" />
//         <span className="font-semibold">50,000+</span>
//         <span className="tracking-widest text-gray-400">NEW JOBS THIS MONTH</span>
//       </motion.div>

//       <motion.h1 className="max-w-2xl text-4xl font-bold md:text-5xl">
...
//         {trending.map((t) => (
//           <motion.span whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.95 }} key={t} className="rounded-full bg-white/5 px-3 py-1 text-gray-300">
//             {t}
//           </motion.span>
//         ))}
//       </div>
...
export default function Hero() {
  ...
  return (
    <section className="flex flex-col items-center px-4 pt-20 pb-10 text-center">
      <motion.div whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.95 }} className="mb-6 flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-4 py-1.5 text-xs">
        <Briefcase size={14} className="text-orange-400" />
        <span className="font-semibold">50,000+</span>
        <span className="tracking-widest text-gray-400">NEW JOBS THIS MONTH</span>
      </motion.div>

      <motion.h1 className="max-w-2xl text-3xl sm:text-4xl md:text-5xl font-bold">
        Find Your Dream Job Today
      </motion.h1>
      <p className="mt-4 max-w-xl text-sm text-gray-400 md:text-base">
        HireLoop connects top talent with world-class companies. Browse thousands of
      ...
      <div className="mt-8 flex w-full max-w-2xl flex-col sm:flex-row items-stretch sm:items-center gap-2 sm:gap-0 rounded-2xl sm:rounded-full border border-white/10 bg-white/5 p-1.5">
        ...
        <button className="flex h-10 w-full sm:w-10 items-center justify-center rounded-full bg-[#6366f1]">
          <Search size={16} className="text-white" />
        </button>
      </div>
